...
[![See it on NPM!](https://img.shields.io/npm/v/@alaskaairux/auro-dropdown?style=for-the-badge&color=orange)](https://www.npmjs.com/package/@alaskaairux/auro-dropdown)
[![License](https://img.shields.io/npm/l/@alaskaairux/auro-dropdown?color=blue&style=for-the-badge)](https://www.apache.org/licenses/LICENSE-2.0)

```shell
$ npm i @alaskaairux/auro-dropdown
```
...
```javascript
import "@alaskaairux/auro-dropdown";
```
...
<script src="https://unpkg.com/@alaskaairux/auro-dropdown@latest/dist/auro-dropdown__bundled.js" type="module"></script>
<script src="https://unpkg.com/@alaskaairux/auro-dropdown@latest/dist/auro-dropdown__bundled.es5.js" nomodule></script>
```
